const AboutUs = () => {
  return (
    <section className='bg-blue-50 mt-10' id='contact '>
      <div className='mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20'>
        <div className='mb-4'>
          <div className='mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12'>
            <p className='text-base font-bold uppercase tracking-wide text-orange-500 '>
              Contact
            </p>
                ...
                <li className='flex'>
                  ...
                  <div className='ml-4 mb-4'>
                    ...
                    <p className='text-gray-600 -400'>
                      Lane no. c-15 , Turner Road , Clement Town
                    </p>
                    <p className='text-gray-600 -400'>Dehradun, 248012</p>
                  </div>
                </li>
                <li className='flex'>
                  <div className='flex h-10 w-10 items-center justify-center rounded bg-orange-500 text-gray-50'>
                  ...
                  <div className='ml-4 mb-4'>
                    ...
                    <p className='text-gray-600 '>Mobile: +91 6203926247</p>
                    <p className='text-gray-600 '>
                      Mail: abhinavranjan2202@gmail.com
                    </p>
                  </div>
                </li>
                <li className='flex'>
